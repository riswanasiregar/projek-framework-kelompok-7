...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{ route('program_bantuan.create') }}" class="btn btn-success text-white w-100">
                <i class="far fa-question-circle me-1"></i> Tambah Data Program Bantuan
            </a>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-program-bantuan" class="table table-centered table-nowrap mb-0 rounded">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-2">
                                    <!-- Edit -->
                                    <a href="{{ route('program_bantuan.edit', $data->program_id) }}" class="btn btn-info btn-sm">
                                        <svg class="icon icon-xs me-2" fill="none" stroke-width="1.5" stroke="currentColor"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1
                                                2.652 2.652L10.582 16.07a4.5 4.5 0
                                                0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5
                                    ...
                                    <!-- Hapus -->
                                    <form action="{{ route('program_bantuan.destroy', $data->program_id) }}" method="POST"
