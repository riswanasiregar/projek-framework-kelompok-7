...
<div class="row">
    ...
    {{-- Tombol Edit --}}
    <a href="{{ route('warga.edit', $data->warga_id) }}" class="btn btn-info btn-sm">
            ...
            <svg class="icon icon-xs me-2" fill="none" stroke-width="1.5"
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21
                         ...
                         1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164
                         -2.09-2.201a51.964 51.964 0 0 0-3.32 
